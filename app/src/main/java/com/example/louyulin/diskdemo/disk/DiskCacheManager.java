package com.example.louyulin.diskdemo.disk;

import android.content.Context;
import android.os.Environment;

import com.example.louyulin.diskdemo.AppContext;
...
public class DiskCacheManager {
    ...
    public DiskCacheManager(Context context, String uniqueName) {
        try {
            ...
            mDiskLruCache = DiskLruCache.open(cacheFile, AppContext.getAppVersion(), 1, 10 * 1024 * 1024);
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
